...
######################################################################
open_mw_cel -library F_PE.mw F_PE_data_setup
...
create_floorplan -core_utilization 0.7 -left_io2core 20 -bottom_io2core 20 -right_io2core 20 -top_io2core 20
...
write_def -version 5.6 -placed -all_vias -blockages  -routed_nets -specialnets -rows_tracks_gcells -output design_data/F_PE.def
